        ...
        return """
{
    ...
    "MISSION.dca_multiteam.collective_assult_parallel_run.py->ScenarioConfig": {
        ...
        "TEAM_NAMES": [
            "ALGORITHM.calf_adj_ent.foundation->ReinforceAlgorithmFoundation",
            // "ALGORITHM.random.foundation->RandomController"
            "TEMP.TEAM2.ALGORITHM.calf_adj_ent.foundation->ReinforceAlgorithmFoundation"
        ]
    },
    "ALGORITHM.calf_adj_ent.foundation.py->AlgorithmConfig": {
    ...
    "TEMP.TEAM2.ALGORITHM.calf_adj_ent.foundation.py->AlgorithmConfig": {
        "train_traj_needed": 32,
        "n_focus_on": 4,
        "lr": 0.0003,
        "ppo_epoch": 16,
...
"""
    ...
    def prev_part(self, X, batch):
        ...
        conf_override.update({
                "ALGORITHM.calf_adj_ent.foundation.py->AlgorithmConfig-->fuzzy_controller_param": [
                    [p1,p2,p3,p4,p5],
                    [p1,p2,p3,p4,p5],
                    [p1,p2,p3,p4,p5],
                    [p1,p2,p3,p4,p5],
        ...
        conf_override.update({
                "ALGORITHM.calf_adj_ent.foundation.py->AlgorithmConfig-->fuzzy_controller_scale_param": [
                    [p6],
                    [p6],
                    [p6],
                    [p6],
    ...
    def get_device_conf(self, batch):
        if batch==0:
            return {
                ########################################
                "ALGORITHM.calf_adj_ent.foundation.py->AlgorithmConfig-->device_override":
                    [
                        "cuda:5",
                        "cuda:5",
                        "cuda:6",
                ...
                "ALGORITHM.calf_adj_ent.foundation.py->AlgorithmConfig-->gpu_party_override":
                    [
                ...
                ########################################
                "TEMP.TEAM2.ALGORITHM.calf_adj_ent.foundation.py->AlgorithmConfig-->device_override":
                    [
                        "cuda:6",
                        "cuda:6",
                        "cuda:5",
                ...
                "TEMP.TEAM2.ALGORITHM.calf_adj_ent.foundation.py->AlgorithmConfig-->gpu_party_override":
                    [
                        "cuda6_party0",
                        "cuda6_party0",
                        "cuda5_party0",
